...
import com.lcx.campus.utils.VectorDistanceUtils;
...
public class EmbeddingTest {
    ...
    public void testVectorStore(){
        FileSystemResource resource = new FileSystemResource("E:\\graduate_design\\project\\2024版学生手册.pdf");
        // 1.创建PDF的读取器
        ...
        SearchRequest request = SearchRequest.builder()
                .query("南京工程学院三好学生评定标准是什么")
                .topK(1)
                .similarityThreshold(0.6)
                .filterExpression("file_name == '2024版学生手册.pdf'")
                .build();
    ...
    void testContextLoad() {
        float[] floats = embeddingModel.embed("动荡不安的世界格局");
