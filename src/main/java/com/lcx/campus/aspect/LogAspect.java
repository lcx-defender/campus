...
import com.lcx.campus.filter.PropertyPreExcludeFilter;
...
public class LogAspect {
    ...
    protected void handleLog(final JoinPoint joinPoint, Log controllerLog, final Exception e, Object jsonResult) {
        try {
            ...
            operateLog.setOperateStatus(BusinessStatus.SUCCESS.ordinal());
            // 请求的地址
            ...
            if (loginUser != null) {
                operateLog.setUserId(loginUser.getUser().getUserId());
            }

            if (e != null) {
                operateLog.setOperateStatus(BusinessStatus.FAIL.ordinal());
